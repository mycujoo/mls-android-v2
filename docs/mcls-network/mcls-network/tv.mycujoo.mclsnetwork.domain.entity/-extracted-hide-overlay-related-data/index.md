...
| | |
|---|---|
| [ExtractedHideOverlayRelatedData](-extracted-hide-overlay-related-data.html) | [androidJvm]<br>fun [ExtractedHideOverlayRelatedData](-extracted-hide-overlay-related-data.html)(id: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), outroAnimationType: AnimationType, outroAnimationDuration: [Long](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-long/index.html)) |
