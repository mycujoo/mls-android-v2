...
| | |
|---|---|
| [DownloaderClient](-downloader-client.html) | [androidJvm]<br>@Inject<br>constructor(okHttpClient: OkHttpClient)<br>takes okHttpClient which will have a Cache layer to skip downloading repeated SVGs |
